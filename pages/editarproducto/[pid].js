...
const EditarProducto = () => {
  ...
  const schemaValidation = Yup.object({
    ...
    existencia: Yup
                  ...
                  .positive('No se acepta 0 o números negativos')
                  .integer('El número de existencia debe ser un entero'),
    precio: Yup
              .number()
  ...
  return ( 
    <Layout>
      <h1 className='text-2xl text-gray-800 font-light'>Desde Editar Producto</h1>
